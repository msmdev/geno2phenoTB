...
module_dir = os.path.join(__location__, "../src/geno2phenotb")
try:
...
spelling_exclude_patterns=["references.rst", "../LICENSE.txt"]
...
try:
    from geno2phenotb import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "geno2phenoTB-doc"
...
latex_documents = [
    (
        "index",
        "user_guide.tex",
        "geno2phenoTB Documentation",
        "Jules Kreuer, Bernhard Reuter",
        "manual",
    )
]
